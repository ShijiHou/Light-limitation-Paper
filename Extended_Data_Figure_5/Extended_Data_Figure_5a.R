...
des.mat <- readTargets("description_matrix_3470.txt")
...
dat_tab <- read.table("CountTable_3470_raw.txt",sep="\t", as.is=TRUE, header=TRUE)
...
pdf("Extended_Data_Figure_5a.pdf", width=10, height=10)
