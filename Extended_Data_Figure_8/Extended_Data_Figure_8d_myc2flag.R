...
des.mat <- readTargets("description_matrix_4339.txt")
...
dat_tab <- read.table("CountTable_4339_raw.txt",sep="\t", as.is=TRUE, header=TRUE)
...
pdf("Extended_Data_Figure_8a_myc2flag.pdf", width=10, height=10)
